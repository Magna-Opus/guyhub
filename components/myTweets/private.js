            ...
            <View style={styles.container}>
                ...
                this.state.users?this.state.users.map((user,index)=>{
                            ...
                            return(
                                        ...
                                        <PrivateList matcheduser={this.getPrivateTweets.bind(this)} key={user.ID} id={user.ID} userid={user.userid} name={user.user.display_name} imageurl={imageurl} date={user.tweet_date} time={user.tweet_time} tweet={user.content} dislikes={(user.unlikes[0])?user.unlikes[0].unlikes:0} like={(user.likes[0])?user.likes[0].likes:0} shareurl={user.tweet_url}/>
                            )
