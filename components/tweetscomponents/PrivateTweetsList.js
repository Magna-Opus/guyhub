...
import { Platform, StyleSheet, Text, View, Image, TouchableOpacity,Alert ,Dimensions,SafeAreaView} from 'react-native';
...
export default class PrivateTweetsList extends Component {
    constructor(props){
        super(props);
